...
class LocalDevicesActivity : AppCompatActivity() {
    ...
    private var devicesList  = arrayListOf<com.garcia.saul.appg.data.model.MBluetoothDevice>()
    ...
    private var broadcastReceiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context, intent: Intent) {
            ...
            if (BluetoothDevice.ACTION_FOUND == action) {
                ...
                val name: String =
                    bluetoothDevice.name ?: applicationContext.resources.getString(R.string.device_unknown)
                devicesList.add(MBluetoothDevice(name = name, address = bluetoothDevice.address, strength = rssi.toString() + applicationContext.resources.getString(R.string.device_dbm)))
                Log.w("Device", name)
            }
        }
    }
